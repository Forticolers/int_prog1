...
INSERT INTO couple(uuid, partenaire1_personne_uuid, partenaire2_personne_uuid, dateDebut, dateFin)
VALUES	('100001' ,'0001' ,'0002' ,TO_DATE('1936/01/01','YYYY/MM/DD') , null),
...
INSERT INTO couple(uuid, partenaire1_personne_uuid, partenaire2_personne_uuid, dateDebut, dateFin)
VALUES	('100011' ,'0011' ,null ,TO_DATE('1970/01/01','YYYY/MM/DD'), null),
...
INSERT INTO couple(uuid, partenaire1_personne_uuid, partenaire2_personne_uuid, dateDebut, dateFin)
VALUES	('100101' ,'0101' ,'0102' ,TO_DATE('1997/01/01','YYYY/MM/DD') , TO_DATE('2010/01/01','YYYY/MM/DD')),
