...
--BEFORE INSERT OR UPDATE OF ajDate, ajUser, moDate, moUser ON composants
...
--BEFORE INSERT OR UPDATE OF ajDate, ajUser, moDate, moUser ON medias
--FOR EACH ROW EXECUTE FUNCTION recette_restrict_audit_column_function();
...
--BEFORE INSERT OR UPDATE OF ajDate, ajUser, moDate, moUser ON unites
--FOR EACH ROW EXECUTE FUNCTION recette_restrict_audit_column_function();
