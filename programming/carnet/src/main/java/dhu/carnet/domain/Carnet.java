...
import dhu.carnet.utils.ArrayList;
import dhu.carnet.utils.List;
import dhu.carnet.utils.SingleDoubleEntryLinkedList;
...
public class Carnet {
    ...
    private int comparerId(Contact contact1, Contact contact2) {
        return contact1.getIdentifiant().getId().compareTo(
